...
def test_a_violation_spec_may_name_its_fields() -> None:
    ...
    rendered = str(domain.Rulebook(domain.RulebookSpec(checks_text)))
...
def test_an_assert_literal_containing_the_clause_is_the_fixture() -> None:
    ...
    rendered = str(domain.Rulebook(domain.RulebookSpec(checks_text, modules)))
...
def test_contracts_pair_each_section_id_with_its_name() -> None:
    ...
    rendered = str(domain.Rulebook(domain.RulebookSpec(checks_text, contracts_text=text)))
