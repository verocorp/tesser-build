...
objects ([`rationale/valueobject/`](rationale/valueobject/)). The `inconsistent/` tests
...
`tesser` base it names. The 46 shipped codes cover value-object shape and
