...
from ddd_vet.finding import CHECKS, codes
from ddd_vet.run import run_paths

_ROOT = Path(__file__).resolve().parents[2]
_PKG = Path(__file__).resolve().parents[1] / "ddd_vet"
...
def test_acceptance_gate_examples_python_is_clean() -> None:
    ...
    # clean on them, exactly as ddd-vet gates examples/ddd on the Go side.
