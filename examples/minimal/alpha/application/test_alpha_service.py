...
class TestAlphaService:
    ...
    def test_add_answers_the_added_name(self) -> None:
        alpha_service = application.AlphaService(FakeWidgetRepository(), FakeOkBetaCheck(), FakeWidgetOrchestratorRelay())
    ...
    def test_a_new_part_is_taken_and_the_widget_saved_kept(self) -> None:
        ...
        add_part_response = application.AlphaService(fake_widget_repository, fake_ok_beta_check, FakeWidgetOrchestratorRelay()).add_part(add_part_request(name="a", part="p"))
    ...
    def test_a_held_part_cleared_by_beta_is_persisted_as_kept(self) -> None:
        fake_widget_repository = FakeWidgetRepository()
        fake_ok_beta_check = FakeOkBetaCheck()
        add_part_response = application.AlphaService(fake_widget_repository, fake_ok_beta_check, FakeWidgetOrchestratorRelay()).add_part(add_part_request(name="a", part="a"))
    ...
    def test_a_held_part_refused_by_beta_is_persisted_as_released(self) -> None:
        ...
        add_part_response = application.AlphaService(fake_widget_repository, fake_refused_beta_check, FakeWidgetOrchestratorRelay()).add_part(add_part_request(name="a", part="a"))
    ...
    def test_an_empty_name_is_rejected_in_the_context_s_own_words(self) -> None:
        fake_widget_repository = FakeWidgetRepository()
        alpha_service = application.AlphaService(fake_widget_repository, FakeOkBetaCheck(), FakeWidgetOrchestratorRelay())
