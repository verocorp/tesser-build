...
class Handler(ts.Handler):
    ...
    def create_campaign(self, req: cli.CliRequest) -> cli.CliResponse:
    ...
    def add_link(self, req: cli.CliRequest) -> cli.CliResponse:
        ...
        return cli.CliResponse.ok(f"campaign {view.campaign_id} now has {len(view.links)} link(s)")

    def deactivate_link(self, req: cli.CliRequest) -> cli.CliResponse:
        ...
        return cli.CliResponse.ok(f"campaign {view.campaign_id} now has {active} active link(s)")
