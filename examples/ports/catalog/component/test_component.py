...
def test_the_wired_client_accepts_a_name_that_is_not_reserved() -> None:
    catalog_client = component.Catalog().client
    add_item_response = catalog_client.add_item(client.AddItemRequest(id="a1", name="Anvil"))
...
def test_the_wired_client_lists_everything_it_stored() -> None:
    catalog_client = component.Catalog().client
    catalog_client.add_item(client.AddItemRequest(id="a1", name="Anvil"))
    catalog_client.add_item(client.AddItemRequest(id="b2", name="Bellows"))
...
def test_two_wirings_do_not_share_what_they_stored() -> None:
    ...
    first.client.add_item(client.AddItemRequest(id="a1", name="Anvil"))
    get_item_response = second.client.get_item(client.GetItemRequest(id="a1"))
