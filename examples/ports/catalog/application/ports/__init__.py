from catalog.application.ports.item_repository import FindItemOutcome as FindItemOutcome
...
from catalog.application.ports.name_policy import CheckNameOutcome as CheckNameOutcome
