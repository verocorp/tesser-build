...
class CallEventsActions(ts.Actions):
    def __init__(self, call_orchestrator_relay: relays.CallOrchestratorRelay) -> None:  # tesser:debt TB081
    ...
    async def person_joined(  # tesser:debt TB082
        ...
        return await self._call_orchestrator_relay.run_person_joined(MapToPersonJoinedRequest(call_id))
    ...
    async def person_turn_completed(  # tesser:debt TB082
        ...
        return await self._call_orchestrator_relay.run_person_turn_completed(
