...
class TestConductCallRequestSnapshot:
    ...
    def test_a_request_comes_back_carrying_the_same_call(self) -> None:
        ...
        conduct_call_request = relays.ConductCallRequest(call=domain.Call(call_spec(call_id="c7", name="Grace")))
        ...
        assert returned.call.person == conduct_call_request.call.person
