...
class TestLivekitSpeech:
    ...
    async def test_speaking_a_turn_asks_the_agent_in_the_room_named_for_the_call(self) -> None:
        FakeRoom.reply = "[]"
        FakeRoom.performed = []
        ...
        await livekit_speech.speak_turn(speak_turn_request(call_id="c7"))
    ...
    async def test_the_agent_is_handed_the_persona_the_turns_so_far_and_the_instructions(self) -> None:
        ...
        await livekit_speech.speak_turn(speak_turn_request(persona="a friendly receptionist", instructions="ask"))
