...
//
// Evidence for skills/tesser-build/application-services.md: this is a
// sanctioned application/outward mapper. It challenges the benchmark's
// decoupled contender on ceremony, not by making the domain emit its own
// representation.
//
