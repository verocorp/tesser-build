...
| (construction) | `TB080` construction-doors (supersedes `TB013`) | a domain constructor takes exactly one `ts.Spec` (entity/aggregate); a value object constructs from primitives and value objects; a spec field is a primitive, a value object, or a child spec; a DTO field is a primitive or another DTO | RULES.md |
