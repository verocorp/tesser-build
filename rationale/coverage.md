...
| A context a host exposes owns a handler; the shared wire vocabulary is app-level | `handlers.md#rules` (rule 5) + `handlers.md#decisions-you-must-make` (4) | — | `python.md#inbound-handlers-and-hosts` | — | "writing a handler / endpoint / controller" |
